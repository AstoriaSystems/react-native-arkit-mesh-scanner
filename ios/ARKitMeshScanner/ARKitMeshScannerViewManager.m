...
@interface RCT_EXTERN_MODULE(ARKitMeshScannerViewManager, RCTViewManager)

RCT_EXPORT_VIEW_PROPERTY(showMesh, BOOL)
RCT_EXPORT_VIEW_PROPERTY(meshColorHex, NSString)
RCT_EXPORT_VIEW_PROPERTY(wireframe, BOOL)
RCT_EXPORT_VIEW_PROPERTY(enableOcclusion, BOOL)
RCT_EXPORT_VIEW_PROPERTY(maxRenderDistance, float)
RCT_EXPORT_VIEW_PROPERTY(cameraDimming, float)
